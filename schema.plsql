...
CREATE USER nv1 IDENTIFIED BY nv1;
CREATE USER nv2 IDENTIFIED BY nv2;
CREATE USER nv3 IDENTIFIED BY nv3;
CREATE USER nv4 IDENTIFIED BY nv4;
CREATE USER nv5 IDENTIFIED BY nv5;
CREATE USER nv6 IDENTIFIED BY nv6;
CREATE USER nv7 IDENTIFIED BY nv7;
CREATE USER nv8 IDENTIFIED BY nv8;
CREATE USER nv9 IDENTIFIED BY nv9;
